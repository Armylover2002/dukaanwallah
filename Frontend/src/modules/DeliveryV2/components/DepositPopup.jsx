  ...
  if (fetchingWallet) {
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center">
        <Loader2 className="w-8 h-8 animate-spin text-[#FE5502] mb-3" />
      ...
      {step === 1 && (
        <div className="p-5 flex flex-col space-y-5">
          <div className="bg-[#F8FAFC] border border-slate-100 rounded-2xl p-5 flex flex-col items-center text-center relative overflow-hidden">
            ...
            <div className="w-10 h-10 rounded-full bg-[#FE5502]/10 flex items-center justify-center text-[#FE5502] mb-3">
            ...
            <div className="mt-4 flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-slate-200/60 border border-slate-300/40 text-[10px] font-semibold text-slate-550">
              <span className="h-1.5 w-1.5 rounded-full bg-[#FE5502] animate-pulse" />
              Locked & Balanced
            </div>
          </div>
            ...
            {paymentMode === "hub" && !selectedZoneId && (
              <div className="flex flex-col h-full space-y-4 animate-in fade-in duration-200">
                <div className="flex items-center justify-between pb-1">
                  ...
                  {loadingZones && (
                    <span className="text-[10px] text-[#FE5502] font-semibold animate-pulse">Loading...</span>
                  )}
                </div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 font-semibold focus:outline-none focus:ring-2 focus:ring-[#FE5502]/20 focus:border-[#FE5502] transition-all text-xs"
                  />
                ...
                <div className="flex-1 overflow-y-auto divide-y divide-slate-100 border border-slate-200 rounded-xl bg-white shadow-sm min-h-[350px]">
                  {loadingZones ? (
                    <div className="flex flex-col items-center justify-center py-16 text-slate-400">
                      <Loader2 className="w-6 h-6 animate-spin text-[#FE5502] mb-2" />
                    ...
                    filteredZones.map((z) => {
                      ...
                      return (
                        <button
                          ...
                          className="w-full text-left px-5 py-4 text-xs font-medium hover:bg-orange-50/50 hover:text-[#FE5502] transition-all flex items-center justify-between text-slate-800 active:bg-orange-50"
                        >
                          <span>{z.zoneName || z.name}</span>
                          <span className="w-5 h-5 rounded-full bg-slate-50 hover:bg-orange-100 flex items-center justify-center text-slate-400 group-hover:text-[#FE5502] transition-colors">
                            →
                          </span>
                        </button>
                      );
            ...
            {paymentMode === "hub" && selectedZoneId && !selectedHubId && (
              <div className="flex flex-col h-full space-y-4 animate-in fade-in duration-200">
                ...
                <div className="flex items-center gap-3 pb-3 border-b border-slate-100">
                  ...
                  <div>
                    <span className="text-[9px] font-bold text-[#FE5502] uppercase tracking-wider block">
                  ...
                  {loadingHubs ? (
                    ...
                    hubs.map((h) => (
                      <button
                        ...
                        className="w-full text-left px-5 py-4 hover:bg-orange-50/50 transition-all flex items-center justify-between group active:bg-orange-50"
                      >
                        <div className="space-y-0.5">
                          <span className="text-xs font-semibold block text-slate-800 group-hover:text-[#FE5502] transition-colors">
                            {h.name}
                          </span>
                        ...
                        <span className="w-5 h-5 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 group-hover:text-[#FE5502] transition-colors">
                          →
                        </span>
                      </button>
                    ))
                    ...
                    <div className="flex-1 space-y-4 overflow-y-auto pr-1">
                      ...
                      <div className="bg-slate-50 border border-slate-150 rounded-2xl p-4 space-y-3.5 text-xs text-slate-700">
                        <div className="flex items-center gap-2 border-b border-slate-200/50 pb-2">
                          <Building className="w-4 h-4 text-[#FE5502]" />
