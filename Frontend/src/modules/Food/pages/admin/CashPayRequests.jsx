            ...
            <div>
              <div className="flex items-center gap-3">
                <div className="p-3 bg-orange-50 rounded-xl">
                  <Receipt className="w-6 h-6 text-orange-600 animate-pulse" />
                </div>
                <div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full xl:w-auto">
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none pl-4 pr-10 py-2.5 w-full sm:w-44 text-xs font-bold bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 cursor-pointer text-slate-700"
                >
              ...
              <div className="relative flex-1 sm:flex-initial sm:min-w-[280px]">
                <input
                  ...
                  className="pl-10 pr-4 py-2.5 w-full text-xs font-semibold rounded-xl border border-slate-200 bg-slate-50/50 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500"
                />
                      ...
                      <tr key={req.id || i} className="hover:bg-slate-50/50 transition-colors group">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right">
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-3 py-1.5 bg-orange-50 hover:bg-orange-100 text-orange-700 hover:text-orange-800 text-xs font-bold rounded-lg border border-orange-100 transition-colors"
                          >
              ...
              <div className="space-y-1.5">
                ...
                {selectedRequest.status === "Pending" ? (
                  <textarea
                    ...
                    disabled={submittingAction}
                    className="w-full p-3 text-xs font-semibold rounded-xl border border-slate-200 bg-slate-50/50 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 disabled:opacity-50"
                  />
                ) : (
