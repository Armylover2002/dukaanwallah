      ...
      <div className="space-y-6">
        ...
        <div className="p-4 rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
          ...
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-orange-100 dark:bg-orange-950/40 text-orange-600 dark:text-orange-400 flex items-center justify-center font-bold text-lg border border-orange-200 dark:border-orange-900/50">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <span className={`inline-flex items-center gap-1 text-xs font-semibold px-2 py-0.5 rounded-full mt-1.5 ${
                  details?.pureVegRestaurant 
                    ...
                    : "bg-orange-50 dark:bg-orange-950/20 text-orange-600 dark:text-orange-400 border border-orange-100 dark:border-orange-900/50"
                }`}>
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-orange-600 dark:text-orange-400 mt-0.5">{getZoneName(details?.zoneId)}</p>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <span className="inline-flex items-center text-xs font-semibold px-2.5 py-0.5 rounded-full bg-orange-50 dark:bg-orange-950/20 text-orange-600 dark:text-orange-400 border border-orange-100 dark:border-orange-900/50 mt-1.5 uppercase">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-orange-600 text-white flex items-center justify-center shadow-lg shadow-orange-500/25 border border-orange-500">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="relative flex-1 max-w-md">
              <input
                ...
                className="pl-10 pr-4 py-2.5 w-full text-sm rounded-lg border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-200 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 dark:focus:ring-orange-500/50 dark:focus:border-orange-500 transition-all"
              />
                ...
                <tr>
                  ...
                  >
                    <div className="flex items-center gap-1">
                      ...
                      <ArrowUpDown className={`w-3 h-3 ${sortConfig.key === "userName" ? "text-orange-600" : "text-slate-400"}`} />
                    </div>
                  </th>
                  <th 
                    className="px-6 py-4 text-left text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-colors"
                  ...
                  >
                    <div className="flex items-center gap-1">
                      ...
                      <ArrowUpDown className={`w-3 h-3 ${sortConfig.key === "role" ? "text-orange-600" : "text-slate-400"}`} />
                    </div>
                  </th>
                  ...
                  >
                    <div className="flex items-center gap-1">
                      ...
                      <ArrowUpDown className={`w-3 h-3 ${sortConfig.key === "createdAt" ? "text-orange-600" : "text-slate-400"}`} />
                    </div>
                  </th>
                  <th 
                    className="px-6 py-4 text-left text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-colors"
                  ...
                  >
                    <div className="flex items-center gap-1">
                      <span>Status</span>
                      <ArrowUpDown className={`w-3 h-3 ${sortConfig.key === "status" ? "text-orange-600" : "text-slate-400"}`} />
                    </div>
                  </th>
                    ...
                    return (
                      <tr key={reqId} className="hover:bg-slate-50/50 dark:hover:bg-slate-900/40 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <div className="w-9 h-9 rounded-full bg-orange-100 dark:bg-orange-950/20 text-orange-600 dark:text-orange-400 flex items-center justify-center font-bold text-sm shrink-0 border border-orange-200/50 dark:border-orange-900/30">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          {role === "RESTAURANT" && (
                            <span className="inline-flex items-center gap-1 text-xs font-bold px-2.5 py-0.5 rounded-full bg-orange-50 dark:bg-orange-950/20 text-orange-600 dark:text-orange-400 border border-orange-100 dark:border-orange-900/50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <button
                            ...
                            className="p-1.5 rounded-lg bg-orange-50 hover:bg-orange-100 dark:bg-orange-950/20 dark:hover:bg-orange-900/30 text-orange-600 dark:text-orange-400 transition-colors border border-orange-100 dark:border-orange-900/30"
