    ...
    <div className="p-4 lg:p-6 bg-slate-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div className="flex items-center gap-2">
              ...
              {filterMode === "all" && selectedIds.size > 0 && (
                <button
                  ...
                  className="px-4 py-2.5 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-lg flex items-center justify-center gap-2 shadow-sm transition-all duration-150 active:scale-95 text-sm"
                >
          ...
          {filterMode === "all" && selectedIds.size > 0 && (
            <div className="mb-4 flex items-center justify-between px-4 py-2.5 bg-orange-50 border border-orange-200 rounded-lg">
                    ...
                    return (
                      <tr
                        ...
                        className={`hover:bg-slate-50/50 transition-colors text-sm text-slate-800 ${
                          filterMode === "all" && isChecked ? "bg-orange-50/40" : ""
                        }`}
                      >
      ...
      <Dialog open={isBulkModalOpen} onOpenChange={setIsBulkModalOpen}>
        <DialogContent className="max-w-md bg-white p-0 overflow-hidden rounded-2xl border-none shadow-2xl">
          <DialogHeader className="px-6 pt-6 pb-4 border-b border-slate-100 bg-orange-50/50">
            <div className="flex items-center gap-3">
          ...
          <form onSubmit={handleBulkCommission}>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-3 pr-10 py-2.5 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-sm"
                    required
                    autoFocus
                  />
                  <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none text-slate-400 font-bold text-sm">
            ...
            <DialogFooter className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex flex-row items-center justify-end gap-3">
              ...
              <button
                ...
                className="px-5 py-2 text-sm font-semibold rounded-lg bg-orange-500 text-white hover:bg-orange-600 transition-all flex items-center gap-1.5 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
              >
