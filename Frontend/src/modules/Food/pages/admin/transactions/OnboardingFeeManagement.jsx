      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-xs border border-slate-200 p-6 mb-6">
          <div className="flex items-center gap-3">
            <div className="p-3 bg-[#FFF3EC] rounded-lg text-[#F26522]">
              ...
              <div className="p-6 border-b border-slate-100 flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                    config.RESTAURANT.isActive ? "bg-[#F26522]" : "bg-slate-300"
                  }`}
                >
                  <span
              ...
              <div className="p-6 bg-slate-50/50 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex-1 max-w-xs">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="pl-8 pr-4 py-2 w-full text-sm rounded-lg border border-slate-300 bg-white focus:outline-none focus:ring-2 focus:ring-[#F26522]/30 focus:border-[#F26522]"
                    />
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-[#F26522] hover:bg-[#d85418] text-white text-sm font-semibold rounded-lg shadow-sm transition-all flex items-center gap-2"
                  >
            ...
            <div className="bg-white rounded-xl shadow-xs border border-slate-200 overflow-hidden hover:shadow-md transition-all duration-300">
              <div className="p-6 border-b border-slate-100 flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                    config.SELLER.isActive ? "bg-[#F26522]" : "bg-slate-300"
                  }`}
                >
                  <span
                    className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
            ...
            <div className="bg-white rounded-xl shadow-xs border border-slate-200 overflow-hidden hover:shadow-md transition-all duration-300">
              <div className="p-6 border-b border-slate-100 flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                    config.DELIVERY_PARTNER.isActive ? "bg-[#F26522]" : "bg-slate-300"
                  }`}
                >
                  <span
                    className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
