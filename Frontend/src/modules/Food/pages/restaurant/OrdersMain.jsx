        ...
        {showNewOrderPopup && (
          <>
            <motion.div
              ...
              exit={{ opacity: 0 }}>
              <motion.div
                className="w-[95%] max-w-md max-h-[calc(100dvh-2rem)] bg-white rounded-[2rem] shadow-2xl overflow-hidden p-1 flex flex-col"
                ...
                <div className="px-4 pb-4 pt-3 border-t border-gray-200 bg-white">
                  <div className="space-y-3">
                    <div
                      ...
                      <motion.div
                        className="absolute inset-y-0 left-0 bg-[#F26522]"
                        initial={{ width: "100%" }}
              ...
              {(isPreparing || isReady || normalizedStatus === "confirmed") && (
                <div className="flex items-center gap-1.5 flex-wrap">
                  <span
                    ...
                    <span
                      className={`h-1.5 w-1.5 rounded-full ${deliveryPartnerId ? "bg-[#FE5502]" : "bg-orange-500"
                        }`}
                    />
