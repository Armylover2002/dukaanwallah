                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-2 flex-1">
                        {selectedItem.foodType === "Veg" ? (
                          ...
                          <div className="h-5 w-5 rounded border-2 border-orange-600 dark:border-orange-500 bg-orange-50 dark:bg-orange-900/30 flex items-center justify-center flex-shrink-0">
