                    ...
                    >
                      ...
                      {pendingCount > 0 && (
                        <span className={`px-2 py-0.5 rounded-full text-[10px] font-black shrink-0 ${
                          isSelected ? "bg-[#0c831f] text-white" : "bg-emerald-50 text-emerald-800 border border-emerald-100"
                        }`}>
                          {pendingCount}
                        </span>
                      )}
                ...
                <div className="p-5 border-b border-slate-100 bg-slate-50/50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div>
                    <h3 className="text-lg font-black text-slate-800 tracking-tight">
                      Pending COD Deposits: <span className="text-[#0c831f]">{selectedZone.zoneName || selectedZone.name}</span>
                    </h3>
                      ...
                      >
                        ...
                        <div className="flex flex-row md:flex-col items-center md:items-end justify-between md:justify-center gap-3 shrink-0 self-stretch md:self-auto border-t md:border-t-0 border-slate-100 pt-3 md:pt-0">
                          ...
                          <button
                            ...
                            className="px-4 py-2 bg-[#0c831f] hover:bg-[#0a6e19] text-white rounded-lg text-xs font-black shadow-sm transition-colors"
                          >
                            Audit & Settle
                          </button>
                        </div>
            ...
            <div className="p-6 overflow-y-auto flex-1 space-y-6 text-xs text-slate-700">
              ...
              <div className="bg-emerald-50/30 border border-emerald-100 p-4 rounded-xl space-y-2.5">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-black text-[#0c831f]">₹{selectedVerification.amount.toLocaleString("en-IN")}</span>
                </div>
            ...
            <div className="p-4 border-t border-slate-150 bg-slate-50 flex items-center justify-between shrink-0">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={actionLoading}
                  className="flex items-center justify-center gap-1.5 px-5 py-2 bg-[#0c831f] hover:bg-[#0a6e19] text-white disabled:opacity-50 rounded-lg font-black transition-all shadow-md"
                >
                  {actionLoading ? (
