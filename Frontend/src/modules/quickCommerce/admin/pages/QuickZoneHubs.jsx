    ...
    <div className="p-4 lg:p-6 bg-slate-50 min-h-screen">
      <div className="w-full mx-auto max-w-7xl">
        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="w-12 h-12 rounded-xl bg-[#0c831f] flex items-center justify-center shadow-md">
          ...
          <div className="lg:col-span-4 bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            {loadingZones ? (
              <div className="p-8 text-center space-y-2">
                <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-[#0c831f] mx-auto"></div>
                  ...
                  return (
                    <div
                      ...
                      className={`p-4 flex items-center justify-between cursor-pointer transition-all hover:bg-slate-50 ${
                        isSelected ? "bg-emerald-50/30 border-l-4 border-l-[#0c831f] font-extrabold" : "border-l-4 border-l-transparent font-medium"
                      }`}
                    >
                      <div className="flex items-center gap-3">
                        <MapPin className={`w-5 h-5 shrink-0 ${isSelected ? "text-[#0c831f]" : "text-slate-400"}`} />
                        <div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div className="p-5 border-b border-slate-100 bg-slate-50/50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div>
                    <h3 className="text-lg font-black text-slate-800 tracking-tight">
                      Active Hubs in <span className="text-[#0c831f]">{selectedZone.zoneName || selectedZone.name}</span>
                    </h3>
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 px-4 py-2 bg-[#0c831f] hover:bg-[#0a6e19] text-white rounded-lg text-sm font-extrabold shadow transition-colors shrink-0"
                  >
                ...
                {loadingSellers ? (
                  <div className="p-12 text-center">
                    <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#0c831f] mx-auto mb-3"></div>
          ...
          <div className="bg-white rounded-xl shadow-2xl border border-slate-200 max-w-xl w-full overflow-hidden flex flex-col max-h-[85vh]">
            ...
            <div className="p-5 border-b border-slate-150 flex items-center justify-between bg-slate-50">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">Designate sellers inside <span className="font-bold text-[#0c831f]">{selectedZone.zoneName || selectedZone.name}</span> as cash hubs</p>
              </div>
              <button 
                    ...
                    return (
                      ...
                      >
                        <div className={`w-5.5 h-5.5 rounded-md border flex items-center justify-center shrink-0 transition-all ${
                          isChecked ? "bg-[#0c831f] border-[#0c831f]" : "border-slate-300 bg-white"
                        }`}>
            ...
            <div className="p-4 border-t border-slate-150 bg-slate-50 flex justify-end gap-3 shrink-0">
              ...
              <button
                ...
                className="rounded-lg py-2.5 px-5 font-bold bg-[#0c831f] hover:bg-[#0a6e19] text-white disabled:opacity-50 transition-colors shadow-sm"
              >
