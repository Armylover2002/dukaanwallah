          ...
          <div className="mt-auto flex items-center justify-between gap-1 pt-0.5 border-t border-slate-200/20">
            ...
            {quantity > 0 ? (
              ...
              <button
                ...
                className="w-6 h-6 md:w-7.5 md:h-7.5 flex items-center justify-center bg-white border-[1px] border-[#FE5502] text-[#FE5502] rounded-lg md:rounded-xl shadow-sm transition-all duration-300 active:scale-95 font-bold hover:bg-[#FE5502] hover:text-white"
              >
