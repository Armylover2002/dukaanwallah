    ...
    <div className="flex gap-0.5">
        {STAR_RATINGS.map((i) => (
            <Star
                ...
                size={size}
                className={cn(
                    i <= rating ? 'text-orange-400 fill-orange-400' : 'text-gray-200 dark:text-slate-800'
                )}
            />
        ))}
    </div>
                                ...
                                <div className="flex-1 px-7 py-6 lg:px-8 lg:py-7 space-y-3">
                                    ...
                                    <div className="flex items-center gap-2 flex-wrap">
                                        ...
                                        >
                                            ...
                                            {avgRating}
                                            <span className="text-orange-400 dark:text-orange-500 font-medium">({reviewCount})</span>
                                        </motion.div>
                                    </div>
                                    ...
                                    >
                                        <h3 className="text-[14px] font-[700] text-gray-900 dark:text-slate-100 flex items-center justify-between tracking-tight">
                                            ...
                                            <div className="flex items-center gap-1 px-2.5 py-1 bg-orange-50 dark:bg-orange-950/30 text-orange-600 dark:text-orange-400 rounded-lg text-[10px] font-[700] border border-orange-100/50 dark:border-orange-900/30">
                                                <Star size={10} fill="currentColor" />
                                                {avgRating}
                                                <span className="text-orange-400 dark:text-orange-500 font-[500] text-[9px]">({reviewCount} reviews)</span>
                                            </div>
                                        </h3>
                                                    ...
                                                    {STAR_RATINGS.map((s) => (
                                                        <motion.button
                                                            ...
                                                            className={cn(
                                                                ...
                                                                newReview.rating >= s
                                                                    ? 'bg-orange-100 dark:bg-orange-950/50 text-orange-500 shadow-sm shadow-orange-100 dark:shadow-none'
                                                                    : 'bg-white dark:bg-slate-800 text-gray-300 dark:text-slate-600 border border-gray-100 dark:border-white/5 hover:border-orange-200'
                                                            )}
                                                        >
