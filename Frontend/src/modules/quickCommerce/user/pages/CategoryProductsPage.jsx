...
const CategoryProductsPage = () => {
    ...
    useEffect(() => {
        ...
        if (storedTheme && /^#[0-9a-fA-F]{6}$/.test(storedTheme)) { setHeaderTheme(storedTheme); return; }
        ...
        if (storedHeaderReturn) {
            try {
                ...
                if (parsed?.color && /^#[0-9a-fA-F]{6}$/.test(parsed.color)) setHeaderTheme(parsed.color);
            } catch { /* ignore */ }
        }
    }, []);
                ...
                >
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            <span className="text-[10px] font-black uppercase tracking-[0.24em] text-white/75">Quick Category</span>
