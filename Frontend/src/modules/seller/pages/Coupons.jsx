    ...
    <div className="min-h-screen bg-slate-50 pb-24 font-sans">
      ...
      <div className="p-4 space-y-4">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-xl bg-orange-600 hover:bg-orange-700 px-4 py-3 font-semibold text-white shadow-lg shadow-orange-600/10 transition-colors"
        >
                  ...
                  <div className="flex justify-between items-start gap-2">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="rounded-lg bg-orange-50 p-2 text-orange-700 hover:bg-orange-100 transition-colors border border-orange-200"
                        title="Edit Coupon"
                      >
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-300 px-4 py-3 outline-none focus:border-orange-600 focus:ring-2 focus:ring-orange-600/10 font-bold tracking-wider"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-slate-300 px-3 py-3 outline-none focus:border-orange-600 focus:ring-2 focus:ring-orange-600/10 bg-white"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-slate-300 px-4 py-3 outline-none focus:border-orange-600 focus:ring-2 focus:ring-orange-600/10"
                    />
                  </div>
                </div>
              ...
              <div className="mt-6 flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 rounded-xl bg-orange-600 hover:bg-orange-700 py-3 font-semibold text-white shadow-lg shadow-orange-600/10 transition-colors"
                >
